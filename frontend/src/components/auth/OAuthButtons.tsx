...
const ROLE_OPTIONS = [
  ...
  },
  {
    ...
    icon: UsersIcon,
    label: "Mentor",
    description: "Guide students and review work",
  },
  {
    value: USER_ROLES.EMPLOYER,
    icon: BriefcaseIcon,
    label: "Employer",
    description: "Post projects and find talent",
  },
] as const;
...
export function OAuthButtons({ flow }: OAuthButtonsProps) {
  ...
  return (
    <>
      ...
      {/* Role Selection Dialog (Register Only) */}
      {flow === "register" && (
        <Dialog open={showRoleDialog} onOpenChange={setShowRoleDialog}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Select how you'll be using Codionix
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="flex gap-3 pt-2">
              ...
              >
                {oauthRegister.isPending ? (
                  ...
                  `Continue with ${selectedProvider === "google" ? "Google" : "GitHub"}`
                )}
              </Button>
            </div>
          </DialogContent>
